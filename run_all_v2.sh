...
# =============================
# 💡 RECALL one-click pipeline
# =============================

BASE_MODEL="Qwen/Qwen2-7B-Instruct"
OUT_DIR="checkpoints_500"
FUSED_DIR="fused_recall_500"
SUBSET=200
SPLIT_TRAIN="train"
SPLIT_TEST="test"
...
echo "========== [STEP 1] Train each task (subset=$SUBSET, split=$SPLIT_TRAIN) =========="
...
python evaluate_all_tasks.py \
  ...
  --base_model $BASE_MODEL \
  --split $SPLIT_TEST \
  --max_examples $SUBSET > recall_results_500.txt

echo "========== [STEP 5] Analyze results =========="
python analyze_results.py

echo "✅ Finished full RECALL reproduction (subset=$SUBSET)"
echo "📂 Check outputs:"
echo "   - $OUT_DIR/"
echo "   - $FUSED_DIR/"
echo "   - recall_results_500.txt"
